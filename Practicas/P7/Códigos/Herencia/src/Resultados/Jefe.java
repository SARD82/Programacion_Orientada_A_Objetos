...
public class Jefe extends Persona {
    ...
    public void mostrarInfo(){
        System.out.println("ID del jefe: " + id_jefe + ", Departamento del jefe: " + departamento_jefe + ", ID: " + id + ", DNI: " + dni + ", Nombre: " + nombre + " " + apellido + ", Domicilio: " + domicilio + ", Telefono: " + telefono); 
    }
}